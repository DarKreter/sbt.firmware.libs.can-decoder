...
class CanDecoder:
    def __init__(self, SBT_dbc_path, KLS_dbc_path) -> None:
        self.sbt_db = cantools.database.load_file(SBT_dbc_path)
    ...
    def decode_payload(self, extID, payload):
        ...
        # Standard SBT CAN ID
            ...
            return self.sbt_db.decode_message(self.decode_paramID(extID), payload)
    ...
    def encode_payload(self, paramIDname, signalName, signalValue):
        ...
        mess = self.sbt_db.get_message_by_name(paramIDname)
        signals = dict()
